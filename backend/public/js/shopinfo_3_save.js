function get_shopinfo_3(){
  var restaurant_name = document.getElementById('restaurant_name_shopinfo_3').textContent;
  var restaurant_intro_short = document.getElementById('restaurant_intro_short_shopinfo_3').textContent;
  var restaurant_intro_long = document.getElementById('restaurant_intro_long_shopinfo_3').textContent;
  var restaurant_image = document.getElementById('restaurant_image_shopinfo_3').src;
  var restaurant_address = document.getElementById('restaurant_address_shopinfo_3').textContent;
  var restaurant_access_line_station = document.getElementById('restaurant_access_line_station_shopinfo_3').textContent;
  var restaurant_access_line_station_walk = document.getElementById('restaurant_access_line_station_walk_shopinfo_3').textContent;
  var restaurant_tell = document.getElementById('restaurant_tell_shopinfo_3').textContent;
  var restaurant_opentime_holiday = document.getElementById('restaurant_opentime_holiday_shopinfo_3').textContent;
  var restaurant_budget = document.getElementById('restaurant_budget_shopinfo_3').textContent;
  var restaurant_credit_card = document.getElementById('restaurant_credit_card_shopinfo_3').textContent;
  var restaurant_e_money = document.getElementById('restaurant_e_money_shopinfo_3').textContent;
  var restaurant_url = document.getElementById('restaurant_url_shopinfo_3').href; 
